...
namespace ProjectWS.Engine.Data.Jpeg
{
    public class Decoder
    {
        ...
        public byte[] DecompressMip(Tex.Header header, int mipLevel, byte[] imageData)
        {
            ...
            for (var i = 0u; i < 4; i++)
            {
                ...
                {
                    Debug.LogWarning("Quality level > 100 ?");
                    return null;
                }
            ...
            Tex.LayerInfo[] layerInfo, float[][] luminosityQuantization, float[][] chrominanceQuantization)
        {
            ...
            switch (format)
            {
                ...
                case 2:
                    ...
                    break;
                default:
                    Debug.LogWarning($"Wrong Compression Format {format}");
                    return null;
            }
        ...
        */
        ...
        byte DecodeValue(BitStream stream, Dictionary<long, byte> table)
        {
            ...
            Debug.LogWarning("Huffman Table doesn't contain word");
            return 0;
        }
